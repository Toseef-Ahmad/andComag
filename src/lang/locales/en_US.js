...
module.exports = {
  ...
  'menu.blank-page': 'Settings',
  'menu.types': 'To Send',
  'menu.levels': 'Sent',
  'menu.third-level-1': 'Active',
  'menu.third-level-2': 'Closed',
  ...
  'menu.forms': 'Records',
  'menu.components': 'Design',
  'menu.layouts': 'Cover images',
  'menu.validations': 'Curiosities',
  'menu.wizard': 'Wizard',
  ...
  'pages.add-new-modal-title': 'Add New Admin',
  'pages.display-options': 'Display Options',
  'pages.orderby': 'Order By : ',
  'pages.product-name': 'Name',
  'pages.product-email': 'Email',
  'pages.product-password': 'Password',
  ...
  'pages.groups': 'Groups',
  'pages.type': 'Type',
  'pages.type_of_plan': 'Type of Plan',
  'pages.subscription': 'Subscription',
  'pages.is-vegan': 'Is Vegan',
  'pages.total-posts': 'Total Pages',
  'pages.last-month-posts': 'Last Month Posts',
  'pages.role': 'Role',
  'pages.order-status': 'No. of Posts left',
  'pages.subs-status': 'Subscription left',
